...
# Install binaries
RUN \
  echo "6b6ecaf7af9b499ae6d73ead06a94b4518c461f56c68664686144b2480f4d558  -" > /tmp/sum.txt && \
  curl -fLs https://parity-downloads-mirror.parity.io/v1.7.13/x86_64-unknown-linux-gnu/parity | \
